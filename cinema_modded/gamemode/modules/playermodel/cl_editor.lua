-- This is a slightly modified version of the Sandbox gamemode.

local wide, tall = 960, 700
...
local function selector()
	...
	window:SetSize( math.min( ScrW() - 16, wide ), math.min( ScrH() - 16, tall ) )
	window:SetSizable( true )
	window:SetMinWidth( wide )
	window:SetMinHeight( tall )
	window:Center()
	window:MakePopup()
...
concommand.Add( "cinema_playermodel_selector", selector )