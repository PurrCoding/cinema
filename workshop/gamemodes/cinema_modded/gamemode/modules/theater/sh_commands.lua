...
CreateConVar( "cinema_url", "https://purrcoding-cinema.pages.dev/", { FCVAR_NOT_CONNECTED, FCVAR_REPLICATED }, "Cinema url to load on theater screens.") -- don't edit, use server config!
